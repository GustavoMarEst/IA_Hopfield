...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1145, 679)
        font = QtGui.QFont()
        font.setPointSize(22)
        MainWindow.setFont(font)
        MainWindow.setAutoFillBackground(False)
        MainWindow.setStyleSheet("background-color: rgb(255, 224, 160);")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(30, 40, 501, 431))
...
"")
        ...
        self.btn_limpiar.setGeometry(QtCore.QRect(620, 540, 161, 81))
        font = QtGui.QFont()
        ...
        self.btn_generar.setGeometry(QtCore.QRect(370, 540, 161, 81))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.btn_generar.setFont(font)
        self.btn_generar.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.btn_generar.setObjectName("btn_generar")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setEnabled(False)
        self.lineEdit.setGeometry(QtCore.QRect(620, 40, 501, 431))
        font = QtGui.QFont()
